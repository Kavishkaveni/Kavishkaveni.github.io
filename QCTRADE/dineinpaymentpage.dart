...
class _TakeAwayPaymentPageState extends State<TakeAwayPaymentPage> {
  ...
  await _printReceipt();  // AUTO PRINT
}
...
Future<void> _printReceipt() async {
  final pdf = await PaymentPDF.generate(
    ...
    subtotal: (settlementData?["total_amount"] as num?)?.toDouble() ?? widget.totalAmount,
    discount: 0,
    tax: 0,
    finalTotal: (settlementData?["total_amount"] as num?)?.toDouble() ?? widget.totalAmount,
